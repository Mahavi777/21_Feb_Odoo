          ...
          <div className="rounded-2xl border bg-card p-10 shadow-xl transition-all duration-300 hover:shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.div variants={staggerContainer} initial="hidden" animate="show" className="space-y-5">
                ...
                {/* Demo Accounts Wrapper inside Staggering */}
                <motion.div variants={staggerItem} className="space-y-3 pt-6 border-t border-border mt-6">
                  <p className="text-center text-xs font-medium text-muted-foreground uppercase tracking-wider">Demo Accounts</p>
                  <div className="grid grid-cols-2 gap-2">
                    <motion.button
                      ...
                      className="rounded-lg border border-indigo-500/20 bg-indigo-500/5 px-2 py-2 text-xs font-semibold text-indigo-500 transition-colors hover:bg-indigo-500/10"
                    >
                      Manager
                    </motion.button>
                    <motion.button
