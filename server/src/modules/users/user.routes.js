...
// Drivers routes
router.get('/drivers', verifyToken, roleGuard(['dispatcher', 'manager']), userController.getDrivers);
router.post('/drivers', verifyToken, roleGuard(['manager']), userController.createDriver);
router.patch('/drivers/:id', verifyToken, roleGuard(['manager']), userController.updateDriverDetails);
